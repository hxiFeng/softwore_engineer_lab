...
/**
 * This class represents a directed graph and provides various functionalities
 * such as displaying the graph, querying bridge words, generating new text,
...
public class lab3 {
  ...
  // 计算最短路径
  public static List<List<String>> calcShortestPath(String word1, String word2) {
  ...
  // 添加边
  public static void addEdge(String fromNode, String toNode, int weight) {
